...
public:
	...
	UFUNCTION()
	void OnRep_Level() { GAMEPLAYATTRIBUTE_REPNOTIFY(URTSProgressionAttributeSet, Level, Level); }
    ...
    UFUNCTION()
    void OnRep_CurrentExp() { GAMEPLAYATTRIBUTE_REPNOTIFY(URTSProgressionAttributeSet, CurrentExp, CurrentExp); }
	...
	UFUNCTION()
	void OnRep_ExpReward() { GAMEPLAYATTRIBUTE_REPNOTIFY(URTSProgressionAttributeSet, ExpReward, ExpReward); }
    ...
    UFUNCTION()
    void OnRep_SkillPoints() { GAMEPLAYATTRIBUTE_REPNOTIFY(URTSProgressionAttributeSet, SkillPoints, SkillPoints); }
    ...
    UFUNCTION()
    void OnRep_StatPoints() { GAMEPLAYATTRIBUTE_REPNOTIFY(URTSProgressionAttributeSet, StatPoints, StatPoints); }
