...
public:
	...
	UFUNCTION()
	void OnRep_Str() { GAMEPLAYATTRIBUTE_REPNOTIFY(URTSStatsAttributeSet, Str, Str); }
    ...
    UFUNCTION()
    void OnRep_Dex() { GAMEPLAYATTRIBUTE_REPNOTIFY(URTSStatsAttributeSet, Dex, Dex); }
	...
	UFUNCTION()
	void OnRep_Int() { GAMEPLAYATTRIBUTE_REPNOTIFY(URTSStatsAttributeSet, Int, Int); }
    ...
    UFUNCTION()
    void OnRep_StrGrowth() { GAMEPLAYATTRIBUTE_REPNOTIFY(URTSStatsAttributeSet, StrGrowth, StrGrowth); }
    ...
    UFUNCTION()
    void OnRep_DexGrowth() { GAMEPLAYATTRIBUTE_REPNOTIFY(URTSStatsAttributeSet, DexGrowth, DexGrowth); }
    ...
    UFUNCTION()
    void OnRep_IntGrowth() { GAMEPLAYATTRIBUTE_REPNOTIFY(URTSStatsAttributeSet, IntGrowth, IntGrowth); }
