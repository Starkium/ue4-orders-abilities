...
public:
	...
	UFUNCTION()
	void OnRep_Currency() { GAMEPLAYATTRIBUTE_REPNOTIFY(URTSCurrencyAttributeSet, Currency, Currency); }
	...
	UFUNCTION()
	void OnRep_Income() { GAMEPLAYATTRIBUTE_REPNOTIFY(URTSCurrencyAttributeSet, Income, Income); }
